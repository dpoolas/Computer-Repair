...
namespace ComputerRepair.admin
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void createTable(int rid, string type, string problem, string status, string details)
        {
            ...
            division.Attributes["class"] = "well top-buffer";
            ...
            using (var reader = cmd.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    commentcell.Controls.Add(commenttable);
                }
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "Select Request_ID, Request_Type, Request_Problem, Request_Status, Request_Details from [Request] ORDER BY Request_UserID";
        ...
        protected void requestsGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
